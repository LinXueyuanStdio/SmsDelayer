...
public class NativeDataManager {
    ...
    public void setObjectServer(String server) {
        mPreference.edit().putString(Constant.KEY_OBJECT_SERVER, server).apply();
    }

    public void setServerRelay(Boolean b) {
        mPreference.edit().putBoolean(Constant.KEY_RELAY_SERVER, b).apply();
    }

    public Boolean getServerRelay() {
        return mPreference.getBoolean(Constant.KEY_RELAY_SERVER, false);
    }
